...
# SEC Floating Feature configuration file for Galaxy A56
...
# Device
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy A56 5G
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMA556B
