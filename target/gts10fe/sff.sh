...
# SEC Floating Feature configuration file for Galaxy Tab S10 FE/FE+
...
# Device
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy S21 Ultra 5G
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMG998B
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_ELECTRIC_RATED_VALUE=DC 9 V; 2.77 A
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_p3s_exynos2100
