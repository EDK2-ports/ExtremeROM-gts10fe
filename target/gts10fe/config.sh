...
# Device configuration file for Galaxy Tab S10 FE+ (Exynos) (gts10fe)
TARGET_NAME="Galaxy Tab S10 FE+ (Exynos)"
TARGET_CODENAME="gts10fe"
TARGET_ASSERT_MODEL=("SM-X620" "SM-X626")
TARGET_PLATFORM="erd8855"
TARGET_FIRMWARE="SM-X620/XAR/R52Y602SL6K"
...
TARGET_HFR_DEFAULT_REFRESH_RATE="60,120"
